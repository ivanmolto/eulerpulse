...
import EthereumVolumes from "@/components/ui/ethereum-volumes/EthereumVolumes";
    ...
    <section aria-label="App Monitoring">
      <dl className="-ml-4 grid grid-cols-1 gap-x-14 gap-y-10 border-t border-gray-200 p-6 md:grid-cols-2 dark:border-gray-800">
        <div className="flex flex-col justify-between p-0">
          ...
          <EthereumVolumes slug="ethereum-daily-volumes" />
        </div>
        <div className="flex flex-col justify-between p-0">
          <div>
            <dt className="text-sm font-semibold text-gray-900 dark:text-gray-50">
          ...
          <EthereumVolumes slug="ethereum-weekly-volumes" />
        </div>
        <div className="flex flex-col justify-between p-0">
          <div>
            <dt className="text-sm font-semibold text-gray-900 dark:text-gray-50">
          ...
          <EthereumVolumes slug="ethereum-monthly-volumes" />
        </div>
        <div className="flex flex-col justify-between p-0">
          <div>
            <dt className="text-sm font-semibold text-gray-900 dark:text-gray-50">
          ...
          <EthereumVolumes slug="ethereum-quarterly-volumes" />
        </div>
      </dl>
    </section>
  );
